...
describe('ReservationController', () => {
    ...
    describe('createReservation', () => {
        ...
        it('should throw ConflictException if reservation already exists', async () => {
            ...
            jest.spyOn(reservationService, 'createReservation').mockRejectedValue(new ConflictException('Reservation conflict'));

            try {
                await controller.createReservation({ user: { id: 1 } }, reservationDto);
            } catch (e) {
                expect(e).toBeInstanceOf(ConflictException);
                expect(e.message).toBe('Reservation conflict');
            }
        });
    });
    ...
    describe('cancelReservation', () => {
        it('should cancel a reservation successfully', async () => {
            ...
            const mockResponse = { message: 'Reservation successfully deleted' };
        ...
        it('should throw NotFoundException if reservation does not exist for the user', async () => {
            ...
            jest.spyOn(reservationService, 'deleteReservation').mockRejectedValue(new NotFoundException('Reservation not found'));
